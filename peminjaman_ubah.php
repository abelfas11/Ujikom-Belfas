        ...
        <div class="col-md-12">
         <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8">
                    <input type="date" class="form-control" value="<? echo $data['tanggal_peminjaman']; ?>" name="tanggal_peminjaman">
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-2">tanggal_pengembalian</div>
                <div class="col-md-8">
                    <input type="date" class="form-control" value="<? echo $data['tanggal_pengembalian']; ?>" name="tanggal_pengembalian">
                </div>
            </div>
            <div class="row mb-3">
